...
df_copa_america <- list(
  ...
  match = list(
    ...
    list(# Chile - Argentina
      ...
      opponent2 = list(id = 0, score = 1, result = "win")
    ),
    list( # Peru - Canada
      id = 8,
      number = 8,
      ...
      opponent2 = list(id = 3, score = 1, result = "win")
    ),
    ...
    list( # Ecuador - Jamaica
      ...
      child_count = 0,
      status = 4,
      opponent1 = list(id = 6, score = 3, result = "winn"),
    ...
    list( # Panama - EEUU
      ...
      child_count = 0,
      status = 4,
      opponent1 = list(id = 10, score = 2, result = "win"),
      opponent2 = list(id = 9, score = 1, result = "loss")
    ),
    list( # Uruguay - Bolivia
      ...
      child_count = 0,
      status = 4,
      opponent1 = list(id = 8, score = 5, result = "win"),
      opponent2 = list(id = 11, score = 0, result = "loss")
    ),
